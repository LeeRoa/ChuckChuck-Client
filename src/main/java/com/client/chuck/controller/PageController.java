...
import com.client.chuck.config.WebClientConfig;
...
//    public ResponseEntity<String> getHolidayData(@RequestParam int year, @RequestParam int month) throws SSLException {
